...
the effect due to any interaction between the *i*-th level of $A$ and
the *j*-th level of $B$.
...
-   Reference levels: $\alpha_1 = 0$, $\beta_1 = 0$,
    $(\alpha\beta)_{1j}=0$ for all $j$ and $(\alpha\beta)_{i1}=0$ for
    all $i$.
...
Still likelihood maximization/ SSE minimization in the regression
formulation of 2-way ANOVA with interactions to get
