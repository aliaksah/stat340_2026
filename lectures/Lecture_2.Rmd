...
-   Least squares estimator : The estimates minimize $SSE(\beta_0,\beta_1) = \sum (y_i - ({\beta}_0 + {\beta}_1 x_i))^2\rightarrow\min$
...
The unconditional (sample) variability of Weight is: $$\sum (y_i - \bar{y})^2 = {SST}$$ Hence, $SST$ (in some literature $SSY$) is a measure of total variability in y, the response
