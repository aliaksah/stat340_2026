...
The unconditional (sample) variance of Weight is: $$\sum (y_i - \bar{y})^2 = {SST}$$ Hence, $SST$ (in some literature $SSY$) is a mesure of total variability in y, the response
